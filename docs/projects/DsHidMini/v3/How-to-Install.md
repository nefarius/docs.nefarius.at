...
!!! note "ControlApp needs .NET Desktop Runtime 10"
    ControlApp requires the **.NET Desktop Runtime 10** to run. To check whether you already have it, simply try opening ControlApp. It will either open normally or prompt you to install [.NET Desktop Runtime 10](https://dotnet.microsoft.com/en-us/download/dotnet/10.0).
