...
This may seem obvious but is amongst the most common errors. In **ControlApp** triple-check **on wired and wireless** that you're actually in XInput Mode as seen below. If you recently changed it and it appears like nothing happened **unplug/disconnect and reconnect the controller** for the settings to become active!

![ControlApp - XInput mode](images/ControlApp XInput.PNG)
